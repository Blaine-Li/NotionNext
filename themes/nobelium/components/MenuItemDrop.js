  ...
  return (
    <li className='mx-3 my-2'>
      <div
        ...
        {hasSubMenu && (
          <ul
            className={`${show ? 'visible opacity-100 top-12 ' : 'invisible opacity-0 top-10 '} border-gray-100  bg-white  dark:bg-[#181818] dark:border-gray-800 transition-all duration-300 z-20 absolute block drop-shadow-lg `}>
